...
const NowPlayingfun = (movie) => {
  let url = "movieDetail5445.html?id=" + encodeURIComponent(movie.id);
...
const html2 = function (moviee) {
  ...
  return `<div class="movie_details">
    <img class="movie_details_poster" src="https://image.tmdb.org/t/p/w500/${      moviee.poster_path    }"
    onerror="this.onerror=null;this.src='https://moviedb.troyenft.xyz/resources/D moviesand tv show.png';"
     alt="title">
...
const recommMovieFun = (mov) => {
  let url = "movieDetail5445.html?id=" + encodeURIComponent(mov.id);
